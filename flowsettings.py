...
#     "default": False,
# }
# For llama-cpp model specs, use n_gpu_layers=LLAMA_CPP_N_GPU_LAYERS so CUDA
# builds offload all layers while CPU-only installs keep the existing safe default.
